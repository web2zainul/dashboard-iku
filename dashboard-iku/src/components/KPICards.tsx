...
const kpiConfig: Array<{
  ...
  { key: 'realisasiAnggaran', label: 'REALISASI ANGGARAN', icon: Banknote, color: 'from-teal-600 to-teal-700', textColor: 'text-teal-100', iconBg: 'bg-white/20', isRupiah: true, fixedValue: 4442912096 },
